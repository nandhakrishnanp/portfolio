...
const Home = () => {
  return (
 <div className='  w-full font-space md:px-12 ' >
    <div className=' h-[70vh]   flex items-center justify-center'>
      <div className=' max-w-4xl max-md:m-8'>

          <h1 className='text-7xl max-md:text-4xl font-bold'>Fullstack Web And Mobile Application Developer</h1>
          ...
          <Link href='/about'> <p className=' border-2 border-white w-fit px-3 py-2 rounded-full'>About Me</p></Link>
      </div>
