...
const Work = () => {
  const project = [
    ...
    },
    {
      ...
      description:
        "a Deep learning based Road Hazard Detection With Platform For Gov Officials and A mobile App for Citizens for Community Reporting",
...

    {
      ...
      description:
        "a cross-platform mobile application built with React Native, complemented by a web-based dashboard. It is designed for real-time monitoring, maintenance, and management of truck tyres",
    ...
    },
    {
      ...
      description:
        "Networking Platform for Students, to create teams, share journeys, realtime chats, and more.",
    ...
    },
    {
      ...
      description:
        "AI-powered assistant for article writing built with React.js and TailwindCSS.",
    ...
    },
    {
      ...
      description:
        "An CGPA Caluculator for students to calculate their CGPA based on their grades and credits with Custom Departments Adding features.",
    ...
    },
    {
      ...
      description:
        "Nike Landing Page featuring product sections, reviews, and more.",
...

    {
      ...
      description:
        "Virtual guide for Bhuvan websites with Natural Language Processing and voice recognition.",
    ...
    },
    {
      ...
      description:
        "Responsive Landing Page for Uniteio WebPage using TailwindCSS, React, and Vite.js.",
...

    {
      ...
      description:
        "Webpage using Express.js and Cheerio for scraping GeekForGeeks profile data.",
    ...
    },
    {
      ...
      description:
        "EV-charging platform with reservation-enabled stations, AI-driven analysis, and reward integration.",
  ...
  return (
    <div className=" w-full flex  justify-center text-white font-space items-center">
      <div className=" md:max-w-4xl max-md:m-8 ">
        {project.map((item) => (
          <article
            className="m-2 my-8 md:flex gap-8 items-center "
            key={item.name}
          >
            <div className="">
              <Image
            ...
            <div className="md:w-1/2 flex flex-col items-start justify-start">
              ...
              <div className=" mt-2 flex gap-4 items-center">
                <a
                  href={item.github}
                  className=" bg-white py-1 px-2 mt-2 rounded-full text-black"
                  target="_blank"
                  rel="noreferrer"
                >
                  Github
                ...
                {item.livePage && (
                  <a href={item.livePage} target="_blank" rel="noreferrer">
                    Live
                  </a>
                )}
              </div>
